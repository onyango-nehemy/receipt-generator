...
const generateReceipt = async (orderData, outputPath) => {
    ...
    doc.moveDown(3)
       ...
       .text('Thank you for shopping with us!', 50, doc.y, { width: 500, align: 'center' })
       .moveDown(0.5)
       .text('For any queries, please contact us at support@onyangogenerals.com', 50, doc.y, { width: 500, align: 'center' })
       .moveDown(1);

    doc.fontSize(7)
       .fillColor('#95A5A6')
       .font('Helvetica')
       .text('GOODS ONCE SOLD CANNOT BE RETURNED.', 50, doc.y, { width: 500, align: 'center' })
       .text('Please retain this receipt for your records.', 50, doc.y, { width: 500, align: 'center' });
